...
<body>
    ...
    <div class="summary">
        <p>Total Transaksi: {{ $incomes->count() }}</p>
        <p>Total Pemasukan: Rp {{ number_format($total, 0, ',', '.') }}</p>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ \Carbon\Carbon::parse($income->tanggal)->locale('id')->isoFormat('D MMM YYYY') }}</td>
    ...
    @else
        <div style="text-align: center; padding: 20px; color: #999;">
            <p>Tidak ada transaksi pemasukan pada bulan ini.</p>
        </div>
    @endif
    ...
    <div class="footer">
        ...
        <p>Admin Dashboard - Detail Pemasukan</p>
    </div>
</body>
</html>
